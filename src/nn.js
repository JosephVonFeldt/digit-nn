...
[ "_guessNum", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
(function() {
 ...
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "nn.data";
  var REMOTE_PACKAGE_BASE = "nn.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_nn.data");
   }
   Module["addRunDependency"]("datafile_nn.data");
 ...
 loadPackage({
  "files": [ {
   "filename": "/testNN3-56SvXXX.nn",
   "start": 0,
   "end": 1022100
  } ],
  "remote_package_size": 1022100
 });
})();
...
if (Module["locateFile"]) {
 wasmBinaryFile = "nn.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("nn.wasm", import.meta.url).href;
}
...
var _guessNum = Module["_guessNum"] = createExportWrapper("guessNum");
